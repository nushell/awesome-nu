...
|-|-|-|-|-|
|[nu-plugin-bexpand](https://forge.axfive.net/Taylor/nu-plugin-bexpand)|1.3.10600|A brace expansion plugin compatible with Bash for nushell|⚠️0.106.0|⚠️0.106.0|
|[nu_plugin_audio_hook](https://github.com/FMotalleb/nu_plugin_audio_hook)|0.106.1|A nushell plugin to make and play sounds|⚠️0.106.1|⚠️0.106.1|
...
|[nu_plugin_bson](https://github.com/Kissaki/nu_plugin_bson)|25.1061.0|Nushell plugin for BSON format (Binary JSON)|⚠️0.106.1|⚠️0.106.1|
...
|[nu_plugin_clipboard](https://github.com/FMotalleb/nu_plugin_clipboard)|0.106.1|A nushell plugin to copy text into clipboard or get text from it.|⚠️0.106.1|⚠️0.106.1|
...
|[nu_plugin_dcm](https://github.com/realcundo/nu_plugin_dcm)|0.4.0|A nushell plugin to parse Dicom files and DICOMweb records|⚠️0.106.0|⚠️0.106.0|
|[nu_plugin_desktop_notifications](https://github.com/FMotalleb/nu_plugin_desktop_notifications)|0.106.1|A nushell plugin to send desktop notifications|⚠️0.106.1|⚠️0.106.1|
|[nu_plugin_dialog](https://github.com/Trivernis/nu-plugin-dialog)|0.2.0|A nushell plugin for user interaction|⚠️0.86.1|⚠️0.86.1|
|[nu_plugin_dns](https://github.com/dead10ck/nu_plugin_dns)|4.0.4-alpha.1|A DNS utility for nushell|⚠️0.106.0|⚠️0.106.0|
|[nu_plugin_dpkgtable](https://github.com/pdenapo/nu_plugin_dpkgtable)|0.1.0||⚠️0.91.0|⚠️0.91.0|
|[nu_plugin_emoji](https://github.com/fdncred/nu_plugin_emoji)|0.15.0|a nushell plugin called emoji|⚠️0.106.0|⚠️0.106.0|
...
|[nu_plugin_file](https://github.com/fdncred/nu_plugin_file)|0.17.0|a nushell plugin called file|⚠️0.106.0|⚠️0.106.0|
|[nu_plugin_format_pcap](https://github.com/b4nst/nu_plugin_format_pcap)|0.1.0||⚠️0.101.0|⚠️0.101.0|
|[nu_plugin_formats](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_formats)|0.107.1|An I/O plugin for a set of file formats for Nushell|✅0.107.1|✅0.107.1|
...
|[nu_plugin_highlight](https://github.com/cptpiepmatz/nu-plugin-highlight)|1.4.8+0.106.0|A nushell plugin for syntax highlighting|⚠️0.106.0|⚠️0.106.0|
|[nu_plugin_hmac](https://github.com/fnuttens/nu_plugin_hmac)|0.20.0|A HMAC sealing plugin for Nushell|⚠️0.106.1|⚠️0.106.1|
|[nu_plugin_image](https://github.com/FMotalleb/nu_plugin_image)|0.106.1|A nushell plugin to open png images in the shell and save ansi string as images (like tables or ...)|⚠️0.106.1|⚠️0.106.1|
|[nu_plugin_inc](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_inc)|0.107.1|A version incrementer plugin for Nushell|✅0.107.1|✅0.107.1|
|[nu_plugin_json_path](https://github.com/fdncred/nu_plugin_json_path)|0.16.0|a nushell plugin created to parse json files using jsonpath|⚠️0.106.0|⚠️0.106.0|
...
|[nu_plugin_parquet](https://github.com/fdncred/nu_plugin_parquet)|0.16.0|nu plugin to add parquet support|⚠️0.106.0|⚠️0.106.0|
...
|[nu_plugin_plotters](https://github.com/cptpiepmatz/nu-jupyter-kernel/tree/main/crates/nu_plugin_plotters)|0.2.1+0.106.0|A nushell plugin for for plotting charts|⛔0.0.0|⛔0.0.0|
...
|[nu_plugin_port_extension](https://github.com/FMotalleb/nu_plugin_port_extension)|0.106.1|A nushell plugin to list all active connections and scanning ports on a target address|⚠️0.106.1|⚠️0.106.1|
...
|[nu_plugin_regex](https://github.com/fdncred/nu_plugin_regex)|0.15.0|nu plugin to search text with regex|⚠️0.106.0|⚠️0.106.0|
|[nu_plugin_rpm](https://github.com/yybit/nu_plugin_rpm)|0.3.5|A nushell plugin for reading rpm package.|⚠️0.105.1|⚠️0.105.1|
|[nu_plugin_semver](https://github.com/abusch/nu_plugin_semver)|0.11.6|A nushell plugin for dealing with SemVer versions|⚠️0.106.0|⚠️0.106.0|
|[nu_plugin_skim](https://github.com/idanarye/nu_plugin_skim)|0.18.0|An `sk` command that can handle Nushell's structured data|⚠️0.106|⚠️0.106|
...
|[nu_plugin_ulid](https://github.com/lizclipse/nu_plugin_ulid)|0.15.0|A nushell plugin that adds various ulid commands|⚠️0.106.0|⚠️0.106.0|
...
last update at `2025-09-03 03:21:49 +00:00`
