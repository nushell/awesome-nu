...
|[nu_plugin_desktop_notifications](https://github.com/FMotalleb/nu_plugin_desktop_notifications)|0.109.1|A nushell plugin to send desktop notifications|✅0.109.1|✅0.109.1|
|[nu_plugin_dialog](https://github.com/Trivernis/nu-plugin-dialog)|0.2.0|A nushell plugin for user interaction|⚠️0.86.1|⚠️0.86.1|
|[nu_plugin_dns](https://github.com/dead10ck/nu_plugin_dns)|4.0.7-alpha.1|A DNS utility for nushell|✅0.109.0|✅0.109.0|
|[nu_plugin_dpkgtable](https://github.com/pdenapo/nu_plugin_dpkgtable)|0.1.0||⚠️0.91.0|⚠️0.91.0|
|[nu_plugin_emoji](https://github.com/fdncred/nu_plugin_emoji)|0.18.0|a nushell plugin called emoji|✅0.109.0|✅0.109.0|
...
|[nu_plugin_file](https://github.com/fdncred/nu_plugin_file)|0.20.0|a nushell plugin called file|✅0.109.0|✅0.109.0|
|[nu_plugin_format_pcap](https://github.com/b4nst/nu_plugin_format_pcap)|0.1.0||⚠️0.101.0|⚠️0.101.0|
|[nu_plugin_formats](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_formats)|0.109.2|An I/O plugin for a set of file formats for Nushell|✅0.109.2|✅0.109.2|
...
|[nu_plugin_gstat](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_gstat)|0.109.2|A git status plugin for Nushell|✅0.109.2|✅0.109.2|
...
|[nu_plugin_highlight](https://github.com/cptpiepmatz/nu-plugin-highlight)|1.4.10+0.108.0|A nushell plugin for syntax highlighting|⚠️0.108.0|⚠️0.108.0|
|[nu_plugin_hmac](https://github.com/fnuttens/nu_plugin_hmac)|0.23.0|A HMAC sealing plugin for Nushell|✅0.109.0|✅0.109.0|
|[nu_plugin_image](https://github.com/FMotalleb/nu_plugin_image)|0.109.1|A nushell plugin to open png images in the shell and save ansi string as images (like tables or ...)|✅0.109.1|✅0.109.1|
|[nu_plugin_inc](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_inc)|0.109.2|A version incrementer plugin for Nushell|✅0.109.2|✅0.109.2|
|[nu_plugin_json_path](https://github.com/fdncred/nu_plugin_json_path)|0.19.0|a nushell plugin created to parse json files using jsonpath|✅0.109.0|✅0.109.0|
...
|[nu_plugin_ls_colorize](https://github.com/brendon-felix/nu_plugin_ls_colorize)|1.0.1+0.109.1|A plugin for Nushell that colorizes paths using LS_COLORS|✅0.109.1|✅0.109.1|
|[nu_plugin_mime](https://github.com/kik4444/nu_plugin_mime)|0.109.1|A simple plugin for working with mime types without performing disk access|✅0.109.1|✅0.109.1|
|[nu_plugin_mongo](https://github.com/WindSoilder/nu_plugin_mongo)|0.1.9|A nushell plugin to interactive with mongodb|✅0.109|✅0.109|
...
|[nu_plugin_nupsql](https://gitlab.com/HertelP/nu_plugin_nupsql)|1.0.0|A nushell plugin to query postgres databases|✅^0.109.0|✅^0.109.0|
|[nu_plugin_nuts](https://github.com/dam4rus/nu_plugin_nuts)|0.1.1|Blazingly fast Nats client as a nushell plugin|✅0.109.1|✅0.109.1|
|[nu_plugin_parquet](https://github.com/fdncred/nu_plugin_parquet)|0.19.0|nu plugin to add parquet support|✅0.109.0|✅0.109.0|
...
|[nu_plugin_prometheus](https://github.com/drbrain/nu_plugin_prometheus)|0.10.0|A nushell plugin for querying prometheus|✅0.109.1|✅0.109.1|
...
|[nu_plugin_semver](https://github.com/abusch/nu_plugin_semver)|0.11.9|A nushell plugin for dealing with SemVer versions|✅0.109.0|✅0.109.0|
|[nu_plugin_skim](https://github.com/idanarye/nu_plugin_skim)|0.21.0|An `sk` command that can handle Nushell's structured data|✅0.109|✅0.109|
...
|[nu_plugin_terminal_qr](https://github.com/Neuron-Mr-White/nu_plugin_terminal_qr)|1.1.1|A nushell plugin to create qr code in terminal|✅0.109.1|✅0.109.1|
|[nu_plugin_termplot](https://github.com/termplot/termplot)|0.1.21|Beautiful plots in your terminal.|⚠️0.105.1|⚠️0.105.1|
|[nu_plugin_ulid](https://github.com/lizclipse/nu_plugin_ulid)|0.18.0|A nushell plugin that adds various ulid commands|✅0.109.0|✅0.109.0|
...
last update at `2026-01-14 04:05:02 +00:00`
