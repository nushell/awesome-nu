...
|-|-|-|-|-|
|[nu-plugin-bexpand](https://forge.axfive.net/Taylor/nu-plugin-bexpand)|1.3.10600|A brace expansion plugin compatible with Bash for nushell|✅0.106.0|✅0.106.0|
|[nu_plugin_audio_hook](https://github.com/FMotalleb/nu_plugin_audio_hook)|0.105.1|A nushell plugin to make and play sounds|⚠️0.105.1|⚠️0.105.1|
...
|[nu_plugin_bson](https://github.com/Kissaki/nu_plugin_bson)|25.1060.0|Nushell plugin for BSON format (Binary JSON)|✅0.106.0|✅0.106.0|
...
|[nu_plugin_clipboard](https://github.com/FMotalleb/nu_plugin_clipboard)|0.106.0|A nushell plugin to copy text into clipboard or get text from it.|✅0.106.0|✅0.106.0|
|[nu_plugin_compress](https://github.com/yybit/nu_plugin_compress)|0.2.8|A nushell plugin for compression and decompression, supporting zstd, gzip, bzip2, and xz.|✅0.106.0|✅0.106.0|
...
|[nu_plugin_dcm](https://github.com/realcundo/nu_plugin_dcm)|0.4.0|A nushell plugin to parse Dicom files and DICOMweb records|✅0.106.0|✅0.106.0|
|[nu_plugin_desktop_notifications](https://github.com/FMotalleb/nu_plugin_desktop_notifications)|0.106.0|A nushell plugin to send desktop notifications|✅0.106.0|✅0.106.0|
...
|[nu_plugin_formats](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_formats)|0.106.2|An I/O plugin for a set of file formats for Nushell|✅0.106.2|✅0.106.2|
...
|[nu_plugin_gstat](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_gstat)|0.106.2|A git status plugin for Nushell|✅0.106.2|✅0.106.2|
...
|[nu_plugin_highlight](https://github.com/cptpiepmatz/nu-plugin-highlight)|1.4.8+0.106.0|A nushell plugin for syntax highlighting|✅0.106.0|✅0.106.0|
|[nu_plugin_hmac](https://github.com/fnuttens/nu_plugin_hmac)|0.19.0|A HMAC sealing plugin for Nushell|⚠️0.105.1|⚠️0.105.1|
|[nu_plugin_image](https://github.com/FMotalleb/nu_plugin_image)|0.106.0|A nushell plugin to open png images in the shell and save ansi string as images (like tables or ...)|✅0.106.0|✅0.106.0|
|[nu_plugin_inc](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_inc)|0.106.2|A version incrementer plugin for Nushell|✅0.106.2|✅0.106.2|
|[nu_plugin_json_path](https://github.com/fdncred/nu_plugin_json_path)|0.16.0|a nushell plugin created to parse json files using jsonpath|✅0.106.0|✅0.106.0|
...
|[nu_plugin_mongo](https://github.com/WindSoilder/nu_plugin_mongo)|0.1.6|A nushell plugin to interactive with mongodb|✅0.106|✅0.106|
...
|[nu_plugin_port_extension](https://github.com/FMotalleb/nu_plugin_port_extension)|0.106.0|A nushell plugin to list all active connections and scanning ports on a target address|✅0.106.0|✅0.106.0|
...
|[nu_plugin_query](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_query)|0.106.2|A Nushell plugin to query JSON, XML, and various web data|✅0.106.2|✅0.106.2|
...
|[nu_plugin_ws](https://github.com/alex-kattathra-johnson/nu_plugin_ws)|0.3.2|A Nushell plugin for easily streaming output from websocket endpoints|⚠️0.105.1|⚠️0.105.1|
...
last update at `2025-07-30 04:01:04 +00:00`
