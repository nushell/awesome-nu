...
|-|-|-|-|-|
|[nu-plugin-bexpand](https://forge.axfive.net/Taylor/nu-plugin-bexpand)|1.3.11100|A brace expansion plugin compatible with Bash for nushell|✅0.111.0|✅0.111.0|
|[nu_plugin_audio](https://github.com/SuaveIV/nu_plugin_audio)|0.2.3|A nushell plugin to make and play sounds|✅0.111.0|✅0.111.0|
...
|[nu_plugin_bigquery](https://github.com/galuszkak/nu_plugin_bigquery)|0.1.1|A Nushell plugin for querying Google BigQuery|✅0.111.0|✅0.111.0|
...
|[nu_plugin_bson](https://github.com/Kissaki/nu_plugin_bson)|26.1110.0|Nushell plugin for BSON format (Binary JSON)|✅0.111.0|✅0.111.0|
...
|[nu_plugin_ccl](https://github.com/punund/nu_plugin_ccl)|0.1.0+0.111.0|A Nushell plugin for CCL format support|✅0.111.0|✅0.111.0|
...
|[nu_plugin_compress](https://github.com/yybit/nu_plugin_compress)|0.2.10|A nushell plugin for compression and decompression, supporting zstd, gzip, bzip2, and xz.|✅0.111.0|✅0.111.0|
...
|[nu_plugin_file](https://github.com/fdncred/nu_plugin_file)|0.22.0|a nushell plugin called file|✅0.111.0|✅0.111.0|
|[nu_plugin_format_pcap](https://github.com/b4nst/nu_plugin_format_pcap)|0.1.0||⚠️0.101.0|⚠️0.101.0|
|[nu_plugin_formats](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_formats)|0.111.1|An I/O plugin for a set of file formats for Nushell|✅0.111.1|✅0.111.1|
...
|[nu_plugin_from_hdf5](https://github.com/Berrysoft/nu_plugin_from_hdf5)|0.1.0|A plugin to parse HDF5 files into nushell record.|✅0.111|✅0.111|
...
|[nu_plugin_ls_colorize](https://github.com/brendon-felix/nu_plugin_ls_colorize)|1.0.3+0.111.0|A plugin for Nushell that colorizes paths using LS_COLORS|✅0.111.0|✅0.111.0|
...
|[nu_plugin_mime_message](https://github.com/punund/nu_plugin_mime_message)|0.1.0+0.111.0|A Nushell plugin for parsing MIME messages and mail streams|✅0.111.0|✅0.111.0|
...
|[nu_plugin_nuts](https://github.com/dam4rus/nu_plugin_nuts)|0.1.2|Blazingly fast Nats client as a nushell plugin|⚠️0.110.0|⚠️0.110.0|
|[nu_plugin_parquet](https://github.com/fdncred/nu_plugin_parquet)|0.21.0|nu plugin to add parquet support|✅0.111.0|✅0.111.0|
...
|[nu_plugin_plotters](https://github.com/cptpiepmatz/nu-jupyter-kernel/tree/main/crates/nu_plugin_plotters)|0.2.4+0.110.0|A nushell plugin for for plotting charts|⛔0.0.0|⛔0.0.0|
...
|[nu_plugin_port_extension](https://github.com/FMotalleb/nu_plugin_port_extension)|0.111.0|A nushell plugin to list all active connections and scanning ports on a target address|✅0.111.0|✅0.111.0|
...
|[nu_plugin_query](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_query)|0.111.1|A Nushell plugin to query JSON, XML, and various web data|✅0.111.1|✅0.111.1|
|[nu_plugin_regex](https://github.com/fdncred/nu_plugin_regex)|0.20.0|nu plugin to search text with regex|✅0.111.0|✅0.111.0|
...
last update at `2026-03-18 04:51:14 +00:00`
