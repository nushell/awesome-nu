...
|[nu_plugin_desktop_notifications](https://github.com/FMotalleb/nu_plugin_desktop_notifications)|0.112.1|A nushell plugin to send desktop notifications|✅0.112.1|✅0.112.1|
...
|[nu_plugin_emoji](https://github.com/fdncred/nu_plugin_emoji)|0.20.0|a nushell plugin called emoji|⚠️0.111.0|⚠️0.111.0|
...
|[nu_plugin_file](https://github.com/fdncred/nu_plugin_file)|0.22.0|a nushell plugin called file|⚠️0.111.0|⚠️0.111.0|
|[nu_plugin_format_pcap](https://github.com/b4nst/nu_plugin_format_pcap)|0.1.0||⚠️0.101.0|⚠️0.101.0|
|[nu_plugin_formats](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_formats)|0.112.2|An I/O plugin for a set of file formats for Nushell|✅0.112.2|✅0.112.2|
...
|[nu_plugin_gstat](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_gstat)|0.112.2|A git status plugin for Nushell|✅0.112.2|✅0.112.2|
...
|[nu_plugin_highlight](https://github.com/cptpiepmatz/nu-plugin-highlight)|1.4.13+0.111.0|A nushell plugin for syntax highlighting|⚠️0.111.0|⚠️0.111.0|
|[nu_plugin_hmac](https://github.com/fnuttens/nu_plugin_hmac)|0.26.0|A HMAC sealing plugin for Nushell|✅0.112.1|✅0.112.1|
|[nu_plugin_image](https://github.com/FMotalleb/nu_plugin_image)|0.112.1|A nushell plugin to open png images in the shell and save ansi string as images (like tables or ...)|✅0.112.1|✅0.112.1|
|[nu_plugin_inc](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_inc)|0.112.2|A version incrementer plugin for Nushell|✅0.112.2|✅0.112.2|
...
|[nu_plugin_json_path](https://github.com/fdncred/nu_plugin_json_path)|0.21.0|a nushell plugin created to parse json files using jsonpath|⚠️0.111.0|⚠️0.111.0|
...
|[nu_plugin_ls_colorize](https://github.com/brendon-felix/nu_plugin_ls_colorize)|1.0.4+0.112.1|A plugin for Nushell that colorizes paths using LS_COLORS|✅0.112.1|✅0.112.1|
...
|[nu_plugin_parquet](https://github.com/fdncred/nu_plugin_parquet)|0.21.0|nu plugin to add parquet support|⚠️0.111.0|⚠️0.111.0|
...
|[nu_plugin_port_extension](https://github.com/FMotalleb/nu_plugin_port_extension)|0.112.1|A nushell plugin to list all active connections and scanning ports on a target address|✅0.112.1|✅0.112.1|
...
|[nu_plugin_query](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_query)|0.112.2|A Nushell plugin to query JSON, XML, and various web data|✅0.112.2|✅0.112.2|
|[nu_plugin_regex](https://github.com/fdncred/nu_plugin_regex)|0.20.0|nu plugin to search text with regex|⚠️0.111.0|⚠️0.111.0|
...
|[nu_plugin_ulid](https://github.com/lizclipse/nu_plugin_ulid)|0.20.0|A nushell plugin that adds various ulid commands|⚠️0.111.0|⚠️0.111.0|
...
last update at `2026-04-15 05:16:26 +00:00`
