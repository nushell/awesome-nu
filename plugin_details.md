...
|-|-|-|-|-|
|[nu-plugin-bexpand](https://forge.axfive.net/Taylor/nu-plugin-bexpand)|1.3.10800|A brace expansion plugin compatible with Bash for nushell|✅0.108.0|✅0.108.0|
|[nu_plugin_audio_hook](https://github.com/FMotalleb/nu_plugin_audio_hook)|0.108.0|A nushell plugin to make and play sounds|✅0.108.0|✅0.108.0|
...
|[nu_plugin_emoji](https://github.com/fdncred/nu_plugin_emoji)|0.17.0|a nushell plugin called emoji|✅0.108.0|✅0.108.0|
|[nu_plugin_endecode](https://github.com/KAAtheWiseGit/nugins/tree/trunk/endecode)|0.108.0|A plugin with various encoding schemes, from Crockford's base-32 to HTML entity escaping.|⚠️0.102.0|⚠️0.102.0|
...
|[nu_plugin_file](https://github.com/fdncred/nu_plugin_file)|0.19.1|a nushell plugin called file|✅0.108.0|✅0.108.0|
|[nu_plugin_format_pcap](https://github.com/b4nst/nu_plugin_format_pcap)|0.1.0||⚠️0.101.0|⚠️0.101.0|
|[nu_plugin_formats](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_formats)|0.108.1|An I/O plugin for a set of file formats for Nushell|✅0.108.1|✅0.108.1|
...
|[nu_plugin_gstat](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_gstat)|0.108.1|A git status plugin for Nushell|✅0.108.1|✅0.108.1|
...
|[nu_plugin_highlight](https://github.com/cptpiepmatz/nu-plugin-highlight)|1.4.10+0.108.0|A nushell plugin for syntax highlighting|✅0.108.0|✅0.108.0|
|[nu_plugin_hmac](https://github.com/fnuttens/nu_plugin_hmac)|0.22.0|A HMAC sealing plugin for Nushell|✅0.108.0|✅0.108.0|
...
|[nu_plugin_inc](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_inc)|0.108.1|A version incrementer plugin for Nushell|✅0.108.1|✅0.108.1|
|[nu_plugin_json_path](https://github.com/fdncred/nu_plugin_json_path)|0.18.0|a nushell plugin created to parse json files using jsonpath|✅0.108.0|✅0.108.0|
...
|[nu_plugin_ls_colorize](https://github.com/brendon-felix/nu_plugin_ls_colorize)|1.0.0+0.108.0|A plugin for Nushell that colorizes paths using LS_COLORS|✅0.108.0|✅0.108.0|
|[nu_plugin_mime](https://github.com/kik4444/nu_plugin_mime)|0.108.0|A simple plugin for working with mime types without performing disk access|✅0.108.0|✅0.108.0|
...
|[nu_plugin_nupsql](https://gitlab.com/HertelP/nu_plugin_nupsql)|1.0.0|A nushell plugin to query postgres databases|✅^0.108.0|✅^0.108.0|
...
|[nu_plugin_parquet](https://github.com/fdncred/nu_plugin_parquet)|0.18.0|nu plugin to add parquet support|✅0.108.0|✅0.108.0|
...
|[nu_plugin_ulid](https://github.com/lizclipse/nu_plugin_ulid)|0.17.1|A nushell plugin that adds various ulid commands|✅0.108.0|✅0.108.0|
...
last update at `2025-11-26 03:43:48 +00:00`
