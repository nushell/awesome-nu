...
|[nu_plugin_audio_hook](https://github.com/FMotalleb/nu_plugin_audio_hook)|0.2.6|A nushell plugin to make and play sounds|✅0.99.0|✅0.99.0|
|[nu_plugin_bash_env](https://github.com/tesujimath/nu_plugin_bash_env)|0.16.1|Nu plugin bash-env|✅0.99.0|✅0.99.0|
...
|[nu_plugin_dns](https://github.com/dead10ck/nu_plugin_dns)|3.0.6-alpha.1|A DNS utility for nushell|✅0.99.0|✅0.99.0|
...
|[nu_plugin_endecode](https://codeberg.org/kaathewise/nugins/src/branch/trunk/endecode)|0.99.0|A plugin with various encoding schemes, from Crockford's base-32 to HTML entity escaping.|✅0.99.0|✅0.99.0|
...
|[nu_plugin_hmac](https://github.com/fnuttens/nu_plugin_hmac)|0.11.0|A HMAC sealing plugin for Nushell|✅0.99.0|✅0.99.0|
|[nu_plugin_image](https://github.com/FMotalleb/nu_plugin_image)|0.5.6|A nushell plugin to open png images in the shell and save ansi string as images (like tables or ...)|✅0.99.0|✅0.99.0|
|[nu_plugin_inc](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_inc)|0.99.2|A version incrementer plugin for Nushell|✅0.99.2|✅0.99.2|
...
|[nu_plugin_mime](https://github.com/kik4444/nu_plugin_mime)|0.99.0|A simple plugin for working with mime types without performing disk access|✅0.99.0|✅0.99.0|
|[nu_plugin_mongo](https://github.com/WindSoilder/nu_plugin_mongo)|0.1.0||✅0.99|✅0.99|
...
|[nu_plugin_query](https://github.com/nushell/nushell/tree/main/crates/nu_plugin_query)|0.99.2|A Nushell plugin to query JSON, XML, and various web data|✅0.99.2|✅0.99.2|
...
|[nu_plugin_semver](https://github.com/abusch/nu_plugin_semver)|0.9.0|A nushell plugin for dealing with SemVer versions|✅0.99.0|✅0.99.0|
|[nu_plugin_skim](https://github.com/idanarye/nu_plugin_skim)|0.8.0|An `sk` command that can handle Nushell's structured data|✅0.99|✅0.99|
...
|[nu_plugin_vec](https://github.com/PhotonBursted/nu_plugin_vec)|1.1.0|A Nushell plugin implementing vector operations|✅0.99.0|✅0.99.0|

last update at `2024-10-21 16:10:28 +00:00`
