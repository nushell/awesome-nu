...
- [nu_plugin_todoist](https://github.com/fhalim/nu_plugin_todoist): A Nushell plugin for interacting with the Todoist API.
...
- [nu-http-client-collection](https://github.com/lassoColombo/nu-http-client-collection): A customizable collection of Nushell HTTP clients generated by the nu-http-client-generator
- [nu-http-client-generator](https://github.com/lassoColombo/nu-http-client-generator): Generates a typed Nushell HTTP client module from an OpenAPI 3.0, Swagger 2.0, or GraphQL introspection spec.
